...
<head>
    ...
    <link rel="icon" href="vit1.png"> 
    <title>VIT Student Management System</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header" style="background-color: skyblue">
                ...
                <a class="navbar-brand" href=""><b>&nbsp;&nbsp;&nbsp; <img src="vit.png" alt="..." width="5%">VIT Student Management System</b></a>
            </div>
            <!-- Top Menu Items -->
            
            <ul class="nav navbar-right top-nav" style="background-color: skyblue">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse"  style="background-color: skyblue">
            <?php 
            include 'db.php';
